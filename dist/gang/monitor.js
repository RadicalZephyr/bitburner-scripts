export async function main(ns) {
    ...
    while (true) {
        ...
        for (const member of members) {
            ...
            ns.printf(` %-${maxNameLength}s | %${maxTaskLength}s %6s %7s %9s %9s`, member.name, member.task, member.hack.toFixed(0), member.hack_exp.toFixed(0), member.hack_asc_mult.toFixed(2), ascResult ? ascResult.hack.toFixed(6) : '');
        }
        ns.print('');
