 ...
 */
export function travelTo(ns, city) {
 ...
 */
export function travelToCityForLocation(ns, location) {
...
function cityForLocation(ns, location) {
    if (anyCityLocation(ns).has(location))
...
function chongqingLocations(ns) {
    return new Set([
