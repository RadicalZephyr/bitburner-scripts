...
async function startTerminal(ns) {
    ns.disableLog('ALL');
    ns.clearLog();
    ns.ui.openTail();
    ...
    ns.printRaw(React.createElement(TerminalApp, { ns: ns, launcher: launcher, resolveScript: resolveScript, memoryClient: memoryClient }));
    await exitOnKill(ns);
}
