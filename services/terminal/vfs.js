 ...
 */
export function splitDirBase(absPath) {
 ...
 */
export function isDirPrefix(candidateDir, path) {
 ...
 */
export function listImmediateChildren(paths, target) {
    ...
    const entries = [...dirEntries.values(), ...fileEntries.values()].sort((a, b) => {
        if (a.kind !== b.kind) {
 ...
 */
export function directoryExists(paths, dir) {
    if (dir === '/') {
        return true;
    }
